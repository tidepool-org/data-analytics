    ...
    with open(dataPathAndName, 'r') as reader:
        for line in reader:
            if line.startswith("Generated:"):
                ...
                all_sections["status_extension_data_manager"] = status_extension_data_manager
                new_line = False
                ...
                all_sections["insulin_counteraction_effects"] = insulin_counteraction_effects
                new_line = False
                ...
                all_sections["retrospective_predicted_glucose"] = retrospective_predicted_glucose
                new_line = False
            ...
            elif line.startswith('### getNormalizedPumpEventDoseEntriesOverlaidWithBasalEntries'):
                ...
                if current_section == 'insulin_counteraction_effects' or current_section == 'get_reservoir_values' or \
                        current_section == 'predicted_glucose' or current_section == 'get_pump_event_values':
                    new_line = False
                ...
                # elif current_section == 'dex_cgm_manager':
