...
def test_parse_by_file():
    ...
    assert (
        loop_dict["insulin_counteration_effects"].to_dict()
        == get_insulin_counteration_effects()
    )
    assert (
        loop_dict["retrospective_glucose_discrepancies_summed"].to_dict()
        == get_retrospective_glucose_discrepancies_summed()
    )
    assert (
        loop_dict["insulin_counteraction_effects"].to_dict()
    ...
    assert (
        loop_dict["retrospective_glucose_discrepancies"].to_dict()
    ...
    assert (
        loop_dict["get_normalized_pump_even_dose"].to_dict()
        == get_normalized_pump_even_dose()
    )
    assert (
        loop_dict["get_normalized_dose_entries"].to_dict()
...
def get_insulin_counteraction_effects():
    return {
        "start_time": {
            0: "2019-01-27 15:21:22 +0000",
            1: "2019-01-27 15:26:22 +0000",
            2: "2019-01-27 15:31:22 +0000",
            3: "2019-01-27 15:36:22 +0000",
            4: "2019-01-27 15:41:22 +0000",
            5: "2019-01-27 15:46:22 +0000",
            6: "2019-01-27 15:51:21 +0000",
            7: "2019-01-27 15:56:22 +0000",
            8: "2019-01-27 16:01:22 +0000",
            9: "2019-01-27 16:06:22 +0000",
            10: "2019-01-27 16:11:22 +0000",
            11: "2019-01-27 16:16:22 +0000",
            12: "2019-01-27 16:21:22 +0000",
        },
        "end_time": {
            0: " 2019-01-27 15:26:22 +0000",
            1: " 2019-01-27 15:31:22 +0000",
            2: " 2019-01-27 15:36:22 +0000",
            3: " 2019-01-27 15:41:22 +0000",
            4: " 2019-01-27 15:46:22 +0000",
            5: " 2019-01-27 15:51:21 +0000",
            6: " 2019-01-27 15:56:22 +0000",
            7: " 2019-01-27 16:01:22 +0000",
            8: " 2019-01-27 16:06:22 +0000",
            9: " 2019-01-27 16:11:22 +0000",
            10: " 2019-01-27 16:16:22 +0000",
            11: " 2019-01-27 16:21:22 +0000",
            12: " 2019-01-27 16:26:22 +0000",
        },
        "value": {
            0: " 0.11340556858587406",
            1: " -0.09644491407321425",
            2: " -0.5038144363643894",
            3: " 0.09110549888380319",
            4: " 0.08806492424520086",
            5: " 0.2877941626511216",
            6: " -0.11365967464421017",
            7: " -0.3170549421296755",
            8: " -0.12201958445077564",
            9: " -0.1286808487354534",
            10: " -0.5368095386319524",
            11: " -0.9461971753678154",
...
def get_retrospective_glucose_discrepancies_summed():
    return {
        "start_time": {
            0: "2018-11-28 00:02:31 +0000",
            1: "2018-11-28 00:02:31 +0000",
            2: "2018-11-28 00:02:31 +0000",
            3: "2018-11-28 00:02:31 +0000",
            4: "2018-11-28 00:02:31 +0000",
            5: "2018-11-28 00:02:31 +0000",
            6: "2018-11-28 00:02:31 +0000",
        },
        "end_time": {
            0: " 2018-11-28 00:02:31 +0000",
            1: " 2018-11-28 00:07:31 +0000",
            2: " 2018-11-28 00:12:31 +0000",
            3: " 2018-11-28 00:17:31 +0000",
            4: " 2018-11-28 00:22:31 +0000",
            5: " 2018-11-28 00:27:31 +0000",
            6: " 2018-11-28 00:32:31 +0000",
        },
        "value": {
            0: " 13.150577197081377",
            1: " 26.06978171944507",
            2: " 38.67818952118729",
            3: " 49.22323442360305",
            4: " 57.644897625857766",
            5: " 64.15869871324333",
            6: " 67.1655997352358",
        },
    }
...
def get_insulin_counteration_effects():
    return {
        "start_time": {
            0: "2019-01-27 15:16:22 +0000",
            1: "2019-01-27 15:21:22 +0000",
            2: "2019-01-27 15:26:22 +0000",
            3: "2019-01-27 15:31:22 +0000",
            4: "2019-01-27 15:36:22 +0000",
            5: "2019-01-27 15:41:22 +0000",
            6: "2019-01-27 15:46:22 +0000",
            7: "2019-01-27 15:51:21 +0000",
            8: "2019-01-27 15:56:22 +0000",
            9: "2019-01-27 16:01:22 +0000",
            10: "2019-01-27 16:06:22 +0000",
            11: "2019-01-27 16:11:22 +0000",
            12: "2019-01-27 16:16:22 +0000",
            13: "2019-01-27 16:21:22 +0000",
        ...
        "end_time": {
            ...
            11: " 2019-01-27 16:16:22 +0000",
            12: " 2019-01-27 16:21:22 +0000",
            13: " 2019-01-27 16:26:22 +0000",
            14: " 2019-01-27 16:31:22 +0000",
        },
        "value": {
            0: " 0.12323223579096947",
            1: " 0.11340556858587406",
            2: " -0.09644491407321425",
            3: " -0.5038144363643894",
            4: " 0.09110549888380319",
            5: " 0.08806492424520086",
            6: " 0.2877941626511216",
            7: " -0.11365967464421017",
            8: " -0.3170549421296755",
            9: " -0.12201958445077564",
            10: " -0.1286808487354534",
            11: " -0.5368095386319524",
            12: " -0.9461971753678154",
            13: " -0.9566544114980243",
            14: " -0.1680095551964925",
        },
    }
...
def get_pump_event_values():
    return {
        "date": "{0: '2019-01-28 13:56:27 +0000'}",
        "description": "{0: nan}",
        "dose": "{0: 'nil'}",
        "duration": "{0: nan}",
        "endDate": "{0: nan}",
        ...
        "persistedDate": "{0: '2019-01-28 14:01:58 +0000'}",
        "rate": "{0: '0.375'}",
        "rateType": "{0: 'MinimedKit.TempBasalPumpEvent.RateType.Absolute'}",
        "raw": "{0: 'Optional(8 bytes'}",
        "rawData": "{0: '8 bytes'}",
        "scheduleEntry": "{0: nan}",
        "scheduledBasalRate": "{0: nan}",
        "startDate": "{0: nan}",
        "syncIdentifier": "{0: nan}",
        "timeOffset": "{0: nan}",
        "timestamp": "{0: 'calendar'}",
        "title": "{0: 'Optional(\"TempBasalPumpEvent(length'}",
        "type": "{0: 'nil'}",
        "unit": "{0: nan}",
        "value": "{0: nan}",
    }
...
def get_cached_dose_entries():
    return {
        "type": {0: "LoopKit.DoseType.basal"},
        "startDate": {0: "2019-01-07 21:26:00 +0000"},
        "endDate": {0: "2019-01-07 21:26:08 +0000"},
        "value": {0: "0.0"},
        "unit": {0: "LoopKit.DoseUnit.units"},
        "description": {0: "nil"},
        "syncIdentifier": {
            0: 'Optional("BasalRateSchedule 2019-01-07T21:26:00Z 2019-01-07T21:26:08Z"'
        },
...
def get_normalized_dose_entries():
    return {
        "type": {0: "LoopKit.DoseType.basal"},
        "startDate": {0: "2019-01-25 04:51:24 +0000"},
        "endDate": {0: "2019-01-25 05:01:25 +0000"},
        "value": {0: "0.6"},
        "unit": {0: "LoopKit.DoseUnit.unitsPerHour"},
        "description": {0: "nil"},
        "syncIdentifier": {0: 'Optional("7b021873141813281800"'},
        "scheduledBasalRate": {0: "nil"},
    }
...
def get_normalized_pump_even_dose():
    return {
        "type": {0: "LoopKit.DoseType.basal"},
        "startDate": {0: "2019-01-27 18:26:42 +0000"},
        "endDate": {0: "2019-01-27 18:30:37 +0000"},
        "value": {0: "0.8"},
        "unit": {0: "LoopKit.DoseUnit.unitsPerHour"},
        "description": {0: "nil"},
        "syncIdentifier": {0: 'Optional("7b012a5a0a1b130d2000"'},
        "scheduledBasalRate": {0: "nil"},
    }
...
def get_insulin_effect():
    return {
        "start_time": {
            0: "2018-11-28 00:30:00 +0000",
            1: "2018-11-28 00:35:00 +0000",
            2: "2018-11-28 00:40:00 +0000",
            3: "2018-11-28 00:45:00 +0000",
            4: "2018-11-28 00:50:00 +0000",
            5: "2018-11-28 00:55:00 +0000",
            6: "2018-11-28 01:00:00 +0000",
            7: "2018-11-28 01:05:00 +0000",
            8: "2018-11-28 01:10:00 +0000",
...
def get_carb_effect():
    return {
        "start_time": {
            0: "2018-11-28 00:00:00 +0000",
            1: "2018-11-28 00:05:00 +0000",
            2: "2018-11-28 00:10:00 +0000",
            3: "2018-11-28 00:15:00 +0000",
            4: "2018-11-28 00:20:00 +0000",
            5: "2018-11-28 00:25:00 +0000",
            6: "2018-11-28 00:30:00 +0000",
            7: "2018-11-28 00:35:00 +0000",
            8: "2018-11-28 00:40:00 +0000",
            9: "2018-11-28 00:45:00 +0000",
            10: "2018-11-28 00:50:00 +0000",
            11: "2018-11-28 00:55:00 +0000",
        ...
        "value": {
            ...
            6: " 309.375",
            7: " 313.1571581860383",
            8: " 320.79604707492723",
            9: " 328.4349359638161",
            10: " 336.073824852705",
            11: " 343.7127137415939",
            12: " 351.3516026304828",
        },
    }
...
def get_retrospective_glucose_discrepancies():
    return {
        ...
        "value": {
            0: " 13.150577197081377",
            1: " 12.919204522363694",
            2: " 12.608407801742223",
            3: " 10.545044902415762",
            4: " 8.421663202254713",
            5: " 6.513801087385557",
            6: " 3.0069010219924754",
        },
    }
...
def get_predicted_glucose():
    return {
        "start_time": {
            0: "2019-01-28 15:16:20 +0000",
            1: "2019-01-28 15:20:00 +0000",
            2: "2019-01-28 15:25:00 +0000",
            3: "2019-01-28 15:30:00 +0000",
            4: "2019-01-28 15:35:00 +0000",
            5: "2019-01-28 15:40:00 +0000",
            6: "2019-01-28 15:45:00 +0000",
            7: "2019-01-28 15:50:00 +0000",
            8: "2019-01-28 15:55:00 +0000",
            9: "2019-01-28 16:00:00 +0000",
            10: "2019-01-28 16:05:00 +0000",
            11: "2019-01-28 16:10:00 +0000",
        },
        "value": {
            0: " 85.0",
            1: " 85.732078872579",
            ...
            8: " 86.5520006409324",
            9: " 86.59083783299144",
            10: " 86.66555585381998",
            11: " 86.77683520191353",
        },
    }
...
def get_reservoir_values():
    return {
        "start_time": {
            0: "2019-01-28 15:16:00 +0000",
            1: "2019-01-28 15:11:00 +0000",
            2: "2019-01-28 15:06:00 +0000",
            3: "2019-01-28 15:01:00 +0000",
            4: "2019-01-28 14:56:00 +0000",
            5: "2019-01-28 14:51:00 +0000",
            6: "2019-01-28 14:46:00 +0000",
            7: "2019-01-28 14:41:00 +0000",
            8: "2019-01-28 14:36:00 +0000",
            9: "2019-01-28 14:31:00 +0000",
            10: "2019-01-28 14:26:00 +0000",
            11: "2019-01-28 14:21:00 +0000",
...
def get_cached_carb_entries():
    return {
        "sampleUUID": {0: " 2C030171-3604-4542-B492-9990AF375546"},
        "syncIdentifier": {0: " 7FF9C039-BE6E-4479-BE4C-3F7EAC1ECF34"},
        "syncVersion": {0: " 1"},
        "startDate": {0: " 2019-01-28 05:41:22 +0000"},
        "quantity": {0: " 7 g"},
        "foodType": {0: " "},
        "absorptionTime": {0: " 10800.0"},
        "createdByCurrentApp": {0: " true"},
        "externalID": {0: " 5c4e9604d8dfb37103e428d1"},
        "isUploaded": {0: " true"},
    }
...
def get_cached_glucose_samples():
    return {
        "sampleUUID": {0: "AFCF551E-BA6D-45A3-9507-18ADCC1F41EB"},
        "syncIdentifier": {0: '"AFCF551E-BA6D-45A3-9507-18ADCC1F41EB"'},
        "syncVersion": {0: "1"},
        "startDate": {0: "2019-01-27 16:36:22 +0000"},
        "quantity": {0: "71 mg/dL"},
        "isDisplayOnly": {0: "false"},
