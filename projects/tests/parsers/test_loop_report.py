...
def test_parse_by_file():
    ...
    assert loop_dict["retrospective_glucose_discrepancies_summed"] == get_retrospective_glucose_discrepancies_summed()
    assert loop_dict["insulin_counteraction_effects"] == get_insulin_counteraction_effects()
    ...
    assert loop_dict["get_normalized_pump_event_dose"] == get_normalized_pump_even_dose()
    ...
    assert loop_dict["dex_cgm_manager"] == {'latestBackfill': {'glucose': ' 98', 'trend': ' 5', 'timestamp': ' 2018-12-13 21'}}
...
def get_pump_event_values():
    return [{'date': '2019-01-28 15:01:27 +0000', 'persistedDate': '2019-01-28 15:06:41 +0000', 'dose': 'nil',
      'isUploaded': 'false',
      'objectIDURL': 'x-coredata://17F97154-93F5-49F8-9870-B15219F6980C/PumpEvent/p50085',
      'raw': 'Optional(8 bytes', 'title': 'Optional(TempBasalPumpEvent(length', 'rawData': '8 bytes',
      'rateType': 'MinimedKit.TempBasalPumpEvent.RateType.Absolute', 'rate': '0.0',
      'timestamp': 'calendar', 'type': 'nil'},
     {'date': '2019-01-28 15:01:27 +0000', 'persistedDate': '2019-01-28 15:06:41 +0000',
      'dose': 'Optional(LoopKit.DoseEntry(type', 'startDate': '2019-01-28 15:01:27 +0000',
      'endDate': '2019-01-28 15:31:27 +0000', 'value': '0.0', 'unit': 'LoopKit.DoseUnit.unitsPerHour',
      'description': 'nil', 'syncIdentifier': 'Optional(16011b41075c13', 'scheduledBasalRate': 'nil',
      'isUploaded': 'true',
      'objectIDURL': 'x-coredata://17F97154-93F5-49F8-9870-B15219F6980C/PumpEvent/p50084',
      'raw': 'Optional(7 bytes', 'title': 'Optional(TempBasalDurationPumpEvent(length',
      'rawData': '7 bytes', 'duration': '30', 'timestamp': 'calendar',
      'type': 'Optional(LoopKit.PumpEventType.tempBasal'},
     {'date': '2019-01-28 14:51:28 +0000', 'persistedDate': '2019-01-28 14:56:28 +0000', 'dose': 'nil',
      'isUploaded': 'false',
      'objectIDURL': 'x-coredata://17F97154-93F5-49F8-9870-B15219F6980C/PumpEvent/p50083',
      'raw': 'Optional(8 bytes', 'title': 'Optional(TempBasalPumpEvent(length', 'rawData': '8 bytes',
      'rateType': 'MinimedKit.TempBasalPumpEvent.RateType.Absolute', 'rate': '0.0',
      'timestamp': 'calendar', 'type': 'nil'},
     {'date': '2019-01-28 14:51:28 +0000', 'persistedDate': '2019-01-28 14:56:28 +0000',
      'dose': 'Optional(LoopKit.DoseEntry(type', 'startDate': '2019-01-28 14:51:28 +0000',
      'endDate': '2019-01-29 14:51:28 +0000', 'value': '0.8', 'unit': 'LoopKit.DoseUnit.unitsPerHour',
      'description': 'nil', 'syncIdentifier': 'Optional(7b011c73061c130d2000',
      'scheduledBasalRate': 'nil', 'isUploaded': 'false',
      'objectIDURL': 'x-coredata://17F97154-93F5-49F8-9870-B15219F6980C/PumpEvent/p50082',
      'raw': 'Optional(10 bytes', 'title': 'Optional(BasalProfileStartPumpEvent(length',
      'rawData': '10 bytes', 'timestamp': 'calendar',
      'scheduleEntry': 'MinimedKit.BasalScheduleEntry(index', 'timeOffset': '23400.0', 'rate': '0.8',
      'type': 'Optional(LoopKit.PumpEventType.basal'},
     {'date': '2019-01-28 14:51:28 +0000', 'persistedDate': '2019-01-28 14:56:28 +0000',
      'dose': 'Optional(LoopKit.DoseEntry(type', 'startDate': '2019-01-28 14:51:28 +0000',
      'endDate': '2019-01-28 14:51:28 +0000', 'value': '0.0', 'unit': 'LoopKit.DoseUnit.unitsPerHour',
      'description': 'nil', 'syncIdentifier': 'Optional(16001c73065c13', 'scheduledBasalRate': 'nil',
      'isUploaded': 'true',
      'objectIDURL': 'x-coredata://17F97154-93F5-49F8-9870-B15219F6980C/PumpEvent/p50081',
      'raw': 'Optional(7 bytes', 'title': 'Optional(TempBasalDurationPumpEvent(length',
      'rawData': '7 bytes', 'duration': '0', 'timestamp': 'calendar',
      'type': 'Optional(LoopKit.PumpEventType.tempBasal'},
     {'date': '2019-01-28 14:46:28 +0000', 'persistedDate': '2019-01-28 14:51:28 +0000', 'dose': 'nil',
      'isUploaded': 'false',
      'objectIDURL': 'x-coredata://17F97154-93F5-49F8-9870-B15219F6980C/PumpEvent/p50080',
      'raw': 'Optional(8 bytes', 'title': 'Optional(TempBasalPumpEvent(length', 'rawData': '8 bytes',
      'rateType': 'MinimedKit.TempBasalPumpEvent.RateType.Absolute', 'rate': '0.0',
      'timestamp': 'calendar', 'type': 'nil'},
     {'date': '2019-01-28 14:46:28 +0000', 'persistedDate': '2019-01-28 14:51:28 +0000',
      'dose': 'Optional(LoopKit.DoseEntry(type', 'startDate': '2019-01-28 14:46:28 +0000',
      'endDate': '2019-01-28 15:16:28 +0000', 'value': '0.0', 'unit': 'LoopKit.DoseUnit.unitsPerHour',
      'description': 'nil', 'syncIdentifier': 'Optional(16011c6e065c13', 'scheduledBasalRate': 'nil',
      'isUploaded': 'true',
      'objectIDURL': 'x-coredata://17F97154-93F5-49F8-9870-B15219F6980C/PumpEvent/p50079',
      'raw': 'Optional(7 bytes', 'title': 'Optional(TempBasalDurationPumpEvent(length',
      'rawData': '7 bytes', 'duration': '30', 'timestamp': 'calendar',
      'type': 'Optional(LoopKit.PumpEventType.tempBasal'},
     {'date': '2019-01-28 14:41:28 +0000', 'persistedDate': '2019-01-28 14:46:28 +0000', 'dose': 'nil',
      'isUploaded': 'false',
      'objectIDURL': 'x-coredata://17F97154-93F5-49F8-9870-B15219F6980C/PumpEvent/p50078',
      'raw': 'Optional(8 bytes', 'title': 'Optional(TempBasalPumpEvent(length', 'rawData': '8 bytes',
      'rateType': 'MinimedKit.TempBasalPumpEvent.RateType.Absolute', 'rate': '1.2',
      'timestamp': 'calendar', 'type': 'nil'},
     {'date': '2019-01-28 14:41:28 +0000', 'persistedDate': '2019-01-28 14:46:28 +0000',
      'dose': 'Optional(LoopKit.DoseEntry(type', 'startDate': '2019-01-28 14:41:28 +0000',
      'endDate': '2019-01-28 15:11:28 +0000', 'value': '1.2', 'unit': 'LoopKit.DoseUnit.unitsPerHour',
      'description': 'nil', 'syncIdentifier': 'Optional(16011c69065c13', 'scheduledBasalRate': 'nil',
      'isUploaded': 'true',
      'objectIDURL': 'x-coredata://17F97154-93F5-49F8-9870-B15219F6980C/PumpEvent/p50077',
      'raw': 'Optional(7 bytes', 'title': 'Optional(TempBasalDurationPumpEvent(length',
      'rawData': '7 bytes', 'duration': '30', 'timestamp': 'calendar',
      'type': 'Optional(LoopKit.PumpEventType.tempBasal'},
     {'date': '2019-01-28 14:36:27 +0000', 'persistedDate': '2019-01-28 14:41:28 +0000', 'dose': 'nil',
      'isUploaded': 'false',
      'objectIDURL': 'x-coredata://17F97154-93F5-49F8-9870-B15219F6980C/PumpEvent/p50076',
      'raw': 'Optional(8 bytes', 'title': 'Optional(TempBasalPumpEvent(length', 'rawData': '8 bytes',
      'rateType': 'MinimedKit.TempBasalPumpEvent.RateType.Absolute', 'rate': '1.4',
      'timestamp': 'calendar', 'type': 'nil'},
     {'date': '2019-01-28 14:36:27 +0000', 'persistedDate': '2019-01-28 14:41:28 +0000',
      'dose': 'Optional(LoopKit.DoseEntry(type', 'startDate': '2019-01-28 14:36:27 +0000',
      'endDate': '2019-01-28 15:06:27 +0000', 'value': '1.4', 'unit': 'LoopKit.DoseUnit.unitsPerHour',
      'description': 'nil', 'syncIdentifier': 'Optional(16011b64065c13', 'scheduledBasalRate': 'nil',
      'isUploaded': 'true',
      'objectIDURL': 'x-coredata://17F97154-93F5-49F8-9870-B15219F6980C/PumpEvent/p50075',
      'raw': 'Optional(7 bytes', 'title': 'Optional(TempBasalDurationPumpEvent(length',
      'rawData': '7 bytes', 'duration': '30', 'timestamp': 'calendar',
      'type': 'Optional(LoopKit.PumpEventType.tempBasal'},
     {'date': '2019-01-28 14:30:00 +0000', 'persistedDate': '2019-01-28 14:31:28 +0000',
      'dose': 'Optional(LoopKit.DoseEntry(type', 'startDate': '2019-01-28 14:30:00 +0000',
      'endDate': '2019-01-29 14:30:00 +0000', 'value': '0.8', 'unit': 'LoopKit.DoseUnit.unitsPerHour',
      'description': 'nil', 'syncIdentifier': 'Optional(7b01005e061c130d2000',
      'scheduledBasalRate': 'nil', 'isUploaded': 'false',
      ...
      'scheduleEntry': 'MinimedKit.BasalScheduleEntry(index', 'timeOffset': '23400.0', 'rate': '0.8',
      'type': 'Optional(LoopKit.PumpEventType.basal'},
     {'date': '2019-01-28 14:06:27 +0000', 'persistedDate': '2019-01-28 14:11:28 +0000',
      'dose': 'Optional(LoopKit.DoseEntry(type', 'startDate': '2019-01-28 14:06:27 +0000',
      'endDate': '2019-01-29 14:06:27 +0000', 'value': '0.8', 'unit': 'LoopKit.DoseUnit.unitsPerHour',
      'description': 'nil', 'syncIdentifier': 'Optional(7b001b46061c13002000',
      'scheduledBasalRate': 'nil', 'isUploaded': 'false',
      'objectIDURL': 'x-coredata://17F97154-93F5-49F8-9870-B15219F6980C/PumpEvent/p50071',
      'raw': 'Optional(10 bytes', 'title': 'Optional(BasalProfileStartPumpEvent(length',
      'rawData': '10 bytes', 'timestamp': 'calendar',
      'scheduleEntry': 'MinimedKit.BasalScheduleEntry(index', 'timeOffset': '0.0', 'rate': '0.8',
      'type': 'Optional(LoopKit.PumpEventType.basal'},
     {'date': '2019-01-28 14:06:27 +0000', 'persistedDate': '2019-01-28 14:11:28 +0000',
      'dose': 'Optional(LoopKit.DoseEntry(type', 'startDate': '2019-01-28 14:06:27 +0000',
      'endDate': '2019-01-28 14:06:27 +0000', 'value': '0.0', 'unit': 'LoopKit.DoseUnit.unitsPerHour',
      'description': 'nil', 'syncIdentifier': 'Optional(16001b46065c13', 'scheduledBasalRate': 'nil',
      'isUploaded': 'true',
      'objectIDURL': 'x-coredata://17F97154-93F5-49F8-9870-B15219F6980C/PumpEvent/p50072',
      'raw': 'Optional(7 bytes', 'title': 'Optional(TempBasalDurationPumpEvent(length',
      'rawData': '7 bytes', 'duration': '0', 'timestamp': 'calendar',
      'type': 'Optional(LoopKit.PumpEventType.tempBasal'},
     {'date': '2019-01-28 14:06:27 +0000', 'persistedDate': '2019-01-28 14:11:28 +0000', 'dose': 'nil',
      'isUploaded': 'false',
      'objectIDURL': 'x-coredata://17F97154-93F5-49F8-9870-B15219F6980C/PumpEvent/p50073',
      'raw': 'Optional(8 bytes', 'title': 'Optional(TempBasalPumpEvent(length', 'rawData': '8 bytes',
      'rateType': 'MinimedKit.TempBasalPumpEvent.RateType.Absolute', 'rate': '0.0',
      'timestamp': 'calendar', 'type': 'nil'},
     {'date': '2019-01-28 14:01:41 +0000', 'persistedDate': '2019-01-28 14:01:58 +0000',
      'dose': 'Optional(LoopKit.DoseEntry(type', 'startDate': '2019-01-28 14:01:41 +0000',
      'endDate': '2019-01-28 14:31:41 +0000', 'value': '0.0', 'unit': 'LoopKit.DoseUnit.unitsPerHour',
      'description': 'nil', 'syncIdentifier': 'Optional(16012941065c13', 'scheduledBasalRate': 'nil',
      'isUploaded': 'true',
      'objectIDURL': 'x-coredata://17F97154-93F5-49F8-9870-B15219F6980C/PumpEvent/p50069',
      'raw': 'Optional(7 bytes', 'title': 'Optional(TempBasalDurationPumpEvent(length',
      'rawData': '7 bytes', 'duration': '30', 'timestamp': 'calendar',
      'type': 'Optional(LoopKit.PumpEventType.tempBasal'},
     {'date': '2019-01-28 14:01:41 +0000', 'persistedDate': '2019-01-28 14:01:58 +0000', 'dose': 'nil',
      'isUploaded': 'false',
      'objectIDURL': 'x-coredata://17F97154-93F5-49F8-9870-B15219F6980C/PumpEvent/p50067',
      'raw': 'Optional(8 bytes', 'title': 'Optional(TempBasalPumpEvent(length', 'rawData': '8 bytes',
      'rateType': 'MinimedKit.TempBasalPumpEvent.RateType.Absolute', 'rate': '0.0',
      'timestamp': 'calendar', 'type': 'nil'},
     {'date': '2019-01-28 13:56:27 +0000', 'persistedDate': '2019-01-28 14:01:58 +0000',
      'dose': 'Optional(LoopKit.DoseEntry(type', 'startDate': '2019-01-28 13:56:27 +0000',
      'endDate': '2019-01-28 14:26:27 +0000', 'value': '0.375', 'unit': 'LoopKit.DoseUnit.unitsPerHour',
      'description': 'nil', 'syncIdentifier': 'Optional(16011b78055c13', 'scheduledBasalRate': 'nil',
      'isUploaded': 'true',
      'objectIDURL': 'x-coredata://17F97154-93F5-49F8-9870-B15219F6980C/PumpEvent/p50070',
      'raw': 'Optional(7 bytes', 'title': 'Optional(TempBasalDurationPumpEvent(length',
      'rawData': '7 bytes', 'duration': '30', 'timestamp': 'calendar',
      'type': 'Optional(LoopKit.PumpEventType.tempBasal'},
     {'date': '2019-01-28 13:56:27 +0000', 'persistedDate': '2019-01-28 14:01:58 +0000', 'dose': 'nil',
      'isUploaded': 'false',
      'objectIDURL': 'x-coredata://17F97154-93F5-49F8-9870-B15219F6980C/PumpEvent/p50068',
      'raw': 'Optional(8 bytes', 'title': 'Optional(TempBasalPumpEvent(length', 'rawData': '8 bytes',
      'rateType': 'MinimedKit.TempBasalPumpEvent.RateType.Absolute', 'rate': '0.375',
      'timestamp': 'calendar', 'type': 'nil'}]
...
def get_insulin_counteraction_effects():
    return [{'start_time': '2019-01-27 15:16:22 +0000', 'end_time': ' 2019-01-27 15:21:22 +0000', 'value': ' 0.12323223579096947', 'units': 'mg/dL/min'}, {'start_time': '2019-01-27 15:21:22 +0000', 'end_time': ' 2019-01-27 15:26:22 +0000', 'value': ' 0.11340556858587406', 'units': 'mg/dL/min'}, {'start_time': '2019-01-27 15:26:22 +0000', 'end_time': ' 2019-01-27 15:31:22 +0000', 'value': ' -0.09644491407321425', 'units': 'mg/dL/min'}, {'start_time': '2019-01-27 15:31:22 +0000', 'end_time': ' 2019-01-27 15:36:22 +0000', 'value': ' -0.5038144363643894', 'units': 'mg/dL/min'}, {'start_time': '2019-01-27 15:36:22 +0000', 'end_time': ' 2019-01-27 15:41:22 +0000', 'value': ' 0.09110549888380319', 'units': 'mg/dL/min'}, {'start_time': '2019-01-27 15:41:22 +0000', 'end_time': ' 2019-01-27 15:46:22 +0000', 'value': ' 0.08806492424520086', 'units': 'mg/dL/min'}, {'start_time': '2019-01-27 15:46:22 +0000', 'end_time': ' 2019-01-27 15:51:21 +0000', 'value': ' 0.2877941626511216', 'units': 'mg/dL/min'}, {'start_time': '2019-01-27 15:51:21 +0000', 'end_time': ' 2019-01-27 15:56:22 +0000', 'value': ' -0.11365967464421017', 'units': 'mg/dL/min'}, {'start_time': '2019-01-27 15:56:22 +0000', 'end_time': ' 2019-01-27 16:01:22 +0000', 'value': ' -0.3170549421296755', 'units': 'mg/dL/min'}, {'start_time': '2019-01-27 16:01:22 +0000', 'end_time': ' 2019-01-27 16:06:22 +0000', 'value': ' -0.12201958445077564', 'units': 'mg/dL/min'}, {'start_time': '2019-01-27 16:06:22 +0000', 'end_time': ' 2019-01-27 16:11:22 +0000', 'value': ' -0.1286808487354534', 'units': 'mg/dL/min'}, {'start_time': '2019-01-27 16:11:22 +0000', 'end_time': ' 2019-01-27 16:16:22 +0000', 'value': ' -0.5368095386319524', 'units': 'mg/dL/min'}, {'start_time': '2019-01-27 16:16:22 +0000', 'end_time': ' 2019-01-27 16:21:22 +0000', 'value': ' -0.9461971753678154', 'units': 'mg/dL/min'}, {'start_time': '2019-01-27 16:21:22 +0000', 'end_time': ' 2019-01-27 16:26:22 +0000', 'value': ' -0.9566544114980243', 'units': 'mg/dL/min'}, {'start_time': '2019-01-27 16:26:22 +0000', 'end_time': ' 2019-01-27 16:31:22 +0000', 'value': ' -0.1680095551964925', 'units': 'mg/dL/min'}]


def get_retrospective_glucose_discrepancies_summed():
    return [{'start_time': '2018-11-28 00:02:31 +0000', 'end_time': ' 2018-11-28 00:02:31 +0000', 'value': ' 13.150577197081377', 'units': 'mg/dL'}, {'start_time': '2018-11-28 00:02:31 +0000', 'end_time': ' 2018-11-28 00:07:31 +0000', 'value': ' 26.06978171944507', 'units': 'mg/dL'}, {'start_time': '2018-11-28 00:02:31 +0000', 'end_time': ' 2018-11-28 00:12:31 +0000', 'value': ' 38.67818952118729', 'units': 'mg/dL'}, {'start_time': '2018-11-28 00:02:31 +0000', 'end_time': ' 2018-11-28 00:17:31 +0000', 'value': ' 49.22323442360305', 'units': 'mg/dL'}, {'start_time': '2018-11-28 00:02:31 +0000', 'end_time': ' 2018-11-28 00:22:31 +0000', 'value': ' 57.644897625857766', 'units': 'mg/dL'}, {'start_time': '2018-11-28 00:02:31 +0000', 'end_time': ' 2018-11-28 00:27:31 +0000', 'value': ' 64.15869871324333', 'units': 'mg/dL'}, {'start_time': '2018-11-28 00:02:31 +0000', 'end_time': ' 2018-11-28 00:32:31 +0000', 'value': ' 67.1655997352358', 'units': 'mg/dL'}]

def get_insulin_counteration_effects():
    return [{'start_time': '2019-01-27 15:16:22 +0000', 'end_time': ' 2019-01-27 15:21:22 +0000',
                     'value': ' 0.12323223579096947', 'units': 'mg/dL/min'},
                    {'start_time': '2019-01-27 15:21:22 +0000', 'end_time': ' 2019-01-27 15:26:22 +0000',
                     'value': ' 0.11340556858587406', 'units': 'mg/dL/min'},
                    {'start_time': '2019-01-27 15:26:22 +0000', 'end_time': ' 2019-01-27 15:31:22 +0000',
                     'value': ' -0.09644491407321425', 'units': 'mg/dL/min'},
                    {'start_time': '2019-01-27 15:31:22 +0000', 'end_time': ' 2019-01-27 15:36:22 +0000',
                     'value': ' -0.5038144363643894', 'units': 'mg/dL/min'},
                    {'start_time': '2019-01-27 15:36:22 +0000', 'end_time': ' 2019-01-27 15:41:22 +0000',
                     'value': ' 0.09110549888380319', 'units': 'mg/dL/min'},
                    {'start_time': '2019-01-27 15:41:22 +0000', 'end_time': ' 2019-01-27 15:46:22 +0000',
                     'value': ' 0.08806492424520086', 'units': 'mg/dL/min'},
                    {'start_time': '2019-01-27 15:46:22 +0000', 'end_time': ' 2019-01-27 15:51:21 +0000',
                     'value': ' 0.2877941626511216', 'units': 'mg/dL/min'},
                    {'start_time': '2019-01-27 15:51:21 +0000', 'end_time': ' 2019-01-27 15:56:22 +0000',
                     'value': ' -0.11365967464421017', 'units': 'mg/dL/min'},
                    {'start_time': '2019-01-27 15:56:22 +0000', 'end_time': ' 2019-01-27 16:01:22 +0000',
                     'value': ' -0.3170549421296755', 'units': 'mg/dL/min'},
                    {'start_time': '2019-01-27 16:01:22 +0000', 'end_time': ' 2019-01-27 16:06:22 +0000',
                     'value': ' -0.12201958445077564', 'units': 'mg/dL/min'},
                    {'start_time': '2019-01-27 16:06:22 +0000', 'end_time': ' 2019-01-27 16:11:22 +0000',
                     'value': ' -0.1286808487354534', 'units': 'mg/dL/min'},
                    {'start_time': '2019-01-27 16:11:22 +0000', 'end_time': ' 2019-01-27 16:16:22 +0000',
                     'value': ' -0.5368095386319524', 'units': 'mg/dL/min'},
                    {'start_time': '2019-01-27 16:16:22 +0000', 'end_time': ' 2019-01-27 16:21:22 +0000',
                     'value': ' -0.9461971753678154', 'units': 'mg/dL/min'},
                    {'start_time': '2019-01-27 16:21:22 +0000', 'end_time': ' 2019-01-27 16:26:22 +0000',
                     'value': ' -0.9566544114980243', 'units': 'mg/dL/min'},
                    {'start_time': '2019-01-27 16:26:22 +0000', 'end_time': ' 2019-01-27 16:31:22 +0000',
                     'value': ' -0.1680095551964925', 'units': 'mg/dL/min'}]
...
def get_g5_cgm_manager():
    return {'transmitter': ' Optional(CGMBLEKit.Transmitter)', 'providesBLEHeartbeat': ' true', 'latestReading': {'glucoseMessage': {'timestamp': ' 2596408', 'glucoseIsDisplayOnly': ' false', 'glucose': ' 85', 'trend': ' -1'}, 'timeMessage': {'status': ' 0', 'currentTime': ' 2596413', 'sessionStartTime': ' 1820222'}, 'transmitterID': ' "00AA0A', 'status': ' CGMBLEKit.TransmitterStatus.ok', 'sessionStartDate': ' 2019-01-19 15', 'lastCalibration': ' nil', 'readDate': ' 2019-01-28 15'}}
