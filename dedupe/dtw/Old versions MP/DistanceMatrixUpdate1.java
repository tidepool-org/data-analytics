public class DistanceMatrixUpdate1 extends SqaureGridUpdate1
{
...
// 		int[] ArrayX = new int[]{137566,137566
// ,137566
// ,137566
// ,137566
// ,137566
...
// 1000};
		...
		int HorizontalTraversals = ArrayX.length+ArrayY.length-1;
		...
		if(ArrayX.length==ArrayY.length)
			{
				...
				System.out.println("6. Percentage Match relative to perfect match_(most total zeros)_" + PercentMatch(ZeroCounter,ArrayX) + "%");
				System.out.println("7. Percentage Match relative to perfect match_(longest continous string of zeros)_"  + PercentMatch(LongestZeroString,ArrayX) + "%");
	...
	{//maybe make them visualize, next to each other. (maybe not practical)
		// System.out.print("Index: DataStrucktures");
				// for(int x=0; x<ArrayX.length; x++)
				// 	{
				// 		System.out.print(x + " ");
				// 		System.out.print(LZScoordinates[x][x]+ " ");
				// 		System.out.print(LongestZeroString[x]+ " ");
				// 		System.out.println(ZeroCounter[x]+ " ");
				// 	}
		System.out.println("Index: DataStrucktures");
		System.out.println("LZScoordinates Points");
		System.out.println("| x | | y |");
		PrintMatrix(LZScoordinates);
		System.out.println("LongestZeroString Array");
		PrintArray(LongestZeroString);
		System.out.println("ZeroCounter Array");
		PrintArray(ZeroCounter);
